...
public class BookInfoService {
    ...
    public BookInfo updateBook(String name, BookInfo updatedBookInfo) {
        ...
        if (existingBook.isPresent()) {
            ...
            book.setName(updatedBookInfo.getName());
            book.setAuthor(updatedBookInfo.getAuthor());
            book.setPublishedYear(updatedBookInfo.getPublishedYear());
            book.setCopiesAvailable(updatedBookInfo.getCopiesAvailable());
